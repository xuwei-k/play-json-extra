...
```scala
libraryDependencies += "com.github.xuwei-k" %% "play-json-extra" % "0.4.2"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/play-json-extra_2.11/0.4.2/play-json-extra_2.11-0.4.2-javadoc.jar/!/index.html)
...
libraryDependencies += "com.github.xuwei-k" %% "play-json-extra" % "0.4.3-SNAPSHOT"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/play-json-extra_2.11/0.4.3-SNAPSHOT/play-json-extra_2.11-0.4.3-SNAPSHOT-javadoc.jar/!/index.html)
