...
libraryDependencies += "com.github.xuwei-k" %% "play-json-extra" % "0.4.1-SNAPSHOT"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/play-json-extra_2.11/0.4.1-SNAPSHOT/play-json-extra_2.11-0.4.1-SNAPSHOT-javadoc.jar/!/index.html)
